        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MainPhone = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    Lead = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Coordinates", x => x.TenantId);
                    table.ForeignKey(
                        name: "FK_Coordinates_Tenants_TenantId",
                        column: x => x.TenantId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("69db714f-9576-45ba-b5b7-f00649be01de"), 0, null, "aaa4a434-66fd-4531-8a07-261720839e3d", "admin@gmail.com", true, false, null, "Admin 1", "ADMIN@GMAIL.COM", "admin", "AQAAAAIAAYagAAAAEGlxY6sibC8HjTZ9r/Vndv2Q0um0lexJ/FIzjnTkoZmPwp1CNUMNOe35Tz6bzoFvhw==", null, false, "", false, "admin" });
